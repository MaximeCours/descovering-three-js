...
const texture = textureLoader.load('https://paulmarechal.xyz/IIM/raw_plank_wall_diff_2k.jpg');

const material1 = new THREE.MeshBasicMaterial({
    map: texture,
});
const material2 = new THREE.MeshLambertMaterial({ color: 0xff0000 });
const material3 = new THREE.MeshLambertMaterial({ color: 0xff00ff }, {metalness: 1})
